...
def domain_const_importable() -> None:
    """Smoke test: the google_photos integration's DOMAIN constant imports cleanly."""
    from homeassistant.components.google_photos.const import DOMAIN  # noqa: PLC0415
    expect(DOMAIN).to_equal("google_photos")
