"""Tryke fixtures for intellifire integration tests."""
...
@fixture
def mock_fp(
    mock_common_data_local: IntelliFireCommonFireplaceData = Depends(mock_common_data_local),
) -> Generator[AsyncMock]:
    """Mock fireplace."""
...
def mock_apis_multifp(
    ...
    mock_local_interface: AsyncMock = Depends(mock_local_interface),
    mock_fp: AsyncMock = Depends(mock_fp),
...
def mock_apis_single_fp(
    ...
    """Single fireplace version of the mocks."""
