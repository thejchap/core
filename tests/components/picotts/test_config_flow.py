...
from tests.hass_fixtures import hass as hass_fixture, issue_registry
...
async def import_flow(
    _trigger: None = Depends(_trigger_executor),
    hass: HomeAssistant = Depends(hass_fixture),
    ir_registry: ir.IssueRegistry = Depends(issue_registry),
) -> None:
    ...
    with patch(
        ...
        expect(hass.config_entries.async_entries(DOMAIN)).to_be_falsy()
        expect(
