"""Tryke fixtures for the gios integration."""
...
@fixture
async def mock_gios(
    mock_gios_stations: dict[int, GiosStation] = Depends(mock_gios_stations),
    mock_gios_sensors: GiosSensors = Depends(mock_gios_sensors),
