...
def domain_const_importable() -> None:
    """Smoke test: the fritzbox integration's DOMAIN constant imports cleanly."""
    from homeassistant.components.fritzbox.const import DOMAIN  # noqa: PLC0415
    expect(DOMAIN).to_equal("fritzbox")
