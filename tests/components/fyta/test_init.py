...
def domain_const_importable() -> None:
    """Smoke test: the fyta integration's DOMAIN constant imports cleanly."""
    from homeassistant.components.fyta.const import DOMAIN  # noqa: PLC0415
    expect(DOMAIN).to_equal("fyta")
