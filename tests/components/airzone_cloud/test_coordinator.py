...
async def coordinator_client_connector_error(
    ...
    # Inject sensor entity_component translation for the temperature device
    # class so the sensor's entity_id slug is "_temperature". The tryke env
    # doesn't compile integration translations.
    fake_translations = {
