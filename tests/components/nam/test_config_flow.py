...
@test.cases(
    ...
    test.case(
        "auth_failed", exc=AuthFailedError("Auth Error"), base_error="invalid_auth"
    ),
...
@test.cases(
    test.case("api_error", exc=ApiError("API Error"), reason="cannot_connect"),
    test.case(
        "cannot_get_mac",
        exc=CannotGetMacError("Cannot get MAC address from device"),
