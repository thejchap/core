...
@test
async def validation_gas_flow_rate_valid(
...
@test
async def validation_gas_flow_rate_wrong_unit(
    hass: HomeAssistant = Depends(hass_fx),
    mock_energy_manager: EnergyManager = Depends(mock_energy_manager_fx),
    mock_get_metadata: dict[str, object] = Depends(mock_get_metadata_fx),
) -> None:
...
@test
async def validation_gas_flow_rate_wrong_state_class(
    hass: HomeAssistant = Depends(hass_fx),
    mock_energy_manager: EnergyManager = Depends(mock_energy_manager_fx),
    mock_get_metadata: dict[str, object] = Depends(mock_get_metadata_fx),
) -> None:
                ...
                [
                    {
                        ...
                        "affected_entities": {
                            ("sensor.gas_flow_rate", "total_increasing")
                        },
...
@test
async def validation_gas_flow_rate_entity_missing(
    hass: HomeAssistant = Depends(hass_fx),
    mock_energy_manager: EnergyManager = Depends(mock_energy_manager_fx),
    mock_get_metadata: dict[str, object] = Depends(mock_get_metadata_fx),
) -> None:
...
@test
async def validation_gas_without_flow_rate(
    hass: HomeAssistant = Depends(hass_fx),
    mock_energy_manager: EnergyManager = Depends(mock_energy_manager_fx),
    mock_get_metadata: dict[str, object] = Depends(mock_get_metadata_fx),
) -> None:
...
@test
async def validation_water_flow_rate_valid(
    hass: HomeAssistant = Depends(hass_fx),
    mock_energy_manager: EnergyManager = Depends(mock_energy_manager_fx),
    mock_get_metadata: dict[str, object] = Depends(mock_get_metadata_fx),
) -> None:
...
@test
async def validation_water_flow_rate_wrong_unit(
    hass: HomeAssistant = Depends(hass_fx),
    mock_energy_manager: EnergyManager = Depends(mock_energy_manager_fx),
    mock_get_metadata: dict[str, object] = Depends(mock_get_metadata_fx),
) -> None:
...
@test
async def validation_water_flow_rate_wrong_state_class(
    hass: HomeAssistant = Depends(hass_fx),
    mock_energy_manager: EnergyManager = Depends(mock_energy_manager_fx),
    mock_get_metadata: dict[str, object] = Depends(mock_get_metadata_fx),
) -> None:
...
@test
async def validation_water_flow_rate_entity_missing(
    hass: HomeAssistant = Depends(hass_fx),
    mock_energy_manager: EnergyManager = Depends(mock_energy_manager_fx),
    mock_get_metadata: dict[str, object] = Depends(mock_get_metadata_fx),
) -> None:
...
@test
async def validation_water_without_flow_rate(
    hass: HomeAssistant = Depends(hass_fx),
    mock_energy_manager: EnergyManager = Depends(mock_energy_manager_fx),
    mock_get_metadata: dict[str, object] = Depends(mock_get_metadata_fx),
) -> None:
...
@test
async def validation_gas_flow_rate_different_units(
    hass: HomeAssistant = Depends(hass_fx),
    mock_energy_manager: EnergyManager = Depends(mock_energy_manager_fx),
    mock_get_metadata: dict[str, object] = Depends(mock_get_metadata_fx),
) -> None:
...
@test
async def validation_gas_flow_rate_recorder_untracked(
    hass: HomeAssistant = Depends(hass_fx),
    mock_energy_manager: EnergyManager = Depends(mock_energy_manager_fx),
...
@test
async def validation_water_flow_rate_recorder_untracked(
    hass: HomeAssistant = Depends(hass_fx),
    mock_energy_manager: EnergyManager = Depends(mock_energy_manager_fx),
    mock_is_entity_recorded: dict[str, bool] = Depends(mock_is_entity_recorded_fx),
    mock_get_metadata: dict[str, object] = Depends(mock_get_metadata_fx),
