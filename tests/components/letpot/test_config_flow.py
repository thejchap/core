...
@test.cases(
    test.case("auth_error", exception=LetPotAuthenticationException, error="invalid_auth"),
    test.case("connection_error", exception=LetPotConnectionException, error="cannot_connect"),
