"""Tryke fixtures for the openweathermap integration."""
...
def owm_client_mock() -> Generator[AsyncMock]:
    ...
    daily_weather_forecast = DailyWeatherForecast(
        ...
        temperature=DailyTemperature(
            day=18.76, min=8.11, max=21.26, night=13.06, evening=20.51, morning=8.47,
        ),
    ...
    current_air_pollution = CurrentAirPollution(
        ...
        aqi=3, co=125.55, no=0.11, no2=0.78, o3=101.98, so2=0.59,
        pm2_5=4.48, pm10=4.77, nh3=4.62,
    )
