...
@test.cases(
    test.case("os_error", side_effect=OSError("Connection refused"), expected_error="cannot_connect"),
    test.case("timeout", side_effect=TimeoutError(), expected_error="cannot_connect"),
    test.case("runtime", side_effect=RuntimeError("Unexpected"), expected_error="unknown"),
)
...
@test.cases(
    test.case("os_error", side_effect=OSError("Connection refused"), expected_reason="cannot_connect"),
    test.case("timeout", side_effect=TimeoutError(), expected_reason="cannot_connect"),
    test.case("runtime", side_effect=RuntimeError("Unexpected"), expected_reason="unknown"),
)
async def import_yaml_config_errors(
    ...
    """Test importing YAML configuration with errors."""
    client.update.side_effect = side_effect
    result = await hass.config_entries.flow.async_init(
        DOMAIN,
        context={"source": SOURCE_IMPORT},
