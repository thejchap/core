...
def module_importable() -> None:
    """Smoke test: the homeassistant.components.risco.switch module imports cleanly."""
    from homeassistant.components.risco import switch  # noqa: PLC0415
...
@test.skip("conftest fixtures need migration to _fixtures.py")
async def cloud_bypass() -> None:
    """Stub for test_cloud_bypass (port deferred)."""

@test.skip("conftest fixtures need migration to _fixtures.py")
async def cloud_unbypass() -> None:
    """Stub for test_cloud_unbypass (port deferred)."""
...
@test.skip("conftest fixtures need migration to _fixtures.py")
async def local_bypass() -> None:
    """Stub for test_local_bypass (port deferred)."""

@test.skip("conftest fixtures need migration to _fixtures.py")
async def local_unbypass() -> None:
    """Stub for test_local_unbypass (port deferred)."""
