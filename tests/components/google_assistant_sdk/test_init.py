...
def domain_const_importable() -> None:
    """Smoke test: the google_assistant_sdk integration's DOMAIN constant imports cleanly."""
    from homeassistant.components.google_assistant_sdk.const import DOMAIN  # noqa: PLC0415
    expect(DOMAIN).to_equal("google_assistant_sdk")
