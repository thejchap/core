...
def module_importable() -> None:
    """Smoke test: the google_assistant_sdk.application_credentials module imports cleanly."""
    from homeassistant.components.google_assistant_sdk import application_credentials  # noqa: PLC0415
