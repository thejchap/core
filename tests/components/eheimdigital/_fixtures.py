"""Tryke fixtures for eheimdigital."""
...
@fixture
def classic_led_ctrl_mock() -> EheimDigitalClassicLEDControl:
...
@fixture
def heater_mock() -> EheimDigitalHeater:
...
@fixture
def classic_vario_mock() -> EheimDigitalClassicVario:
...
@fixture
def filter_mock() -> EheimDigitalFilter:
...
@fixture
def reeflex_mock() -> EheimDigitalReeflexUV:
...
def eheimdigital_hub_mock(
    classic_led_ctrl_mock: EheimDigitalClassicLEDControl = Depends(classic_led_ctrl_mock),
    heater_mock: EheimDigitalHeater = Depends(heater_mock),
    classic_vario_mock: EheimDigitalClassicVario = Depends(classic_vario_mock),
    filter_mock: EheimDigitalFilter = Depends(filter_mock),
    reeflex_mock: EheimDigitalReeflexUV = Depends(reeflex_mock),
) -> Generator[AsyncMock]:
    ...
    with (
        ...
        hub_mock.return_value.main = classic_led_ctrl_mock
        yield hub_mock
