"""Tryke fixtures for NASweb tests."""
...
def validate_input_all_ok() -> Generator[dict[str, AsyncMock | MagicMock]]:
    """Yield a dict of mocks required for successful config_flow execution."""
    with (
        patch(
        ...
        patch(
            ...
            return_value=(
                "http://127.0.0.1:8123/api/webhook/"
                "de705e77291402afa0dd961426e9f19bb53631a9f2a106c52cfd2d2266913c04"
            ),
        ) as get_webhook_url,
        patch(
