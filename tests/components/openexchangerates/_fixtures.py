"""Tryke fixtures for the Open Exchange Rates integration."""
...
def mock_latest_rates_config_flow() -> Generator[AsyncMock]:
    """Mock the latest-rates client method used by the config flow."""
    with patch(
...
@fixture
def currencies() -> Generator[AsyncMock]:
    """Mock the currencies endpoint used by the config flow."""
    with patch(
