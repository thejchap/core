...
@test.cases(
    test.case("connection_error", side_effect=LibreHardwareMonitorConnectionError, error_text="cannot_connect"),
    test.case("no_devices", side_effect=LibreHardwareMonitorNoDevicesError, error_text="no_devices"),
)
...
@test.cases(
    test.case("connection_error", side_effect=LibreHardwareMonitorConnectionError, error_text="cannot_connect"),
    test.case("unauthorized", side_effect=LibreHardwareMonitorUnauthorizedError, error_text="invalid_auth"),
    test.case("no_devices", side_effect=LibreHardwareMonitorNoDevicesError, error_text="no_devices"),
)
