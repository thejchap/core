"""Tryke fixtures for the ista EcoTrend integration."""
...
def mock_ista() -> Generator[MagicMock]:
    ...
    with (
        ...
        client.get_consumption_data.side_effect = _get_consumption_data

        yield client


def _get_consumption_data(obj_uuid: str | None = None) -> dict[str, Any]:
