"""Tryke fixtures for the Forecast.Solar integration."""
...
@fixture
def mock_config_entry(*, api_key_present: bool = True) -> MockConfigEntry:
...
def mock_forecast_solar(
    ...
    with patch(
        ...
        estimate.sum_energy_production.side_effect = {1: 900000}.get
        estimate.watts = {
