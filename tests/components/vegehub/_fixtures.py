"""Tryke fixtures for VegeHub tests."""
...
@fixture
def mocked_config_entry() -> MockConfigEntry:
...
def mock_setup_entry() -> Generator[Any]:
    ...
    with patch("homeassistant.components.vegehub.async_setup_entry", return_value=True):
        yield
