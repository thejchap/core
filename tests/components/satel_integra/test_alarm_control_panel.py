...
def module_importable() -> None:
    """Smoke test: the homeassistant.components.satel_integra.alarm_control_panel module imports cleanly."""
    from homeassistant.components.satel_integra import alarm_control_panel  # noqa: PLC0415
