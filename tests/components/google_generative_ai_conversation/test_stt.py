"""Tryke skip stub for test_stt.py with one passing smoke test."""
...
def module_importable() -> None:
    """Smoke test: the google_generative_ai_conversation.stt module imports cleanly."""
    from homeassistant.components.google_generative_ai_conversation import stt  # noqa: PLC0415
    expect(stt).not_.to_be(None)
