"""Tryke fixtures for the eGauge integration."""
...
def mock_egauge_client() -> Generator[MagicMock]:
    ...
    with (
        ...
        client.get_register_info.return_value = {
            ...
            "Solar": RegisterInfo(name="Solar", type=RegisterType.POWER, idx=1, did=None),
            "Temp": RegisterInfo(name="Temp", type=RegisterType.TEMPERATURE, idx=2, did=None),
