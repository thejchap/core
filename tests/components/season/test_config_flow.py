...
from tests.components.season._fixtures import mock_config_entry, mock_setup_entry
...
async def full_user_flow(
    ...
    expect(result2.get("title")).to_equal("Season")
    expect(result2.get("data")).to_equal({CONF_TYPE: TYPE_ASTRONOMICAL})
