"""Tryke fixtures for the Enphase Envoy integration."""
...
@fixture
async def mock_envoy() -> AsyncGenerator[AsyncMock]:
    ...
    with (
        ...
        load_envoy_fixture(mock_envoy, "envoy")
...
@fixture
async def mock_envoy_metered_batt_relay() -> AsyncGenerator[AsyncMock]:
    """Define a mocked Envoy fixture using the envoy_metered_batt_relay fixture file."""
    new_token = jwt.encode(
        payload={"name": "envoy", "exp": 2007837780},
        key="secret",
        algorithm="HS256",
    ...
    with (
        ...
        load_envoy_fixture(mock_envoy, "envoy_metered_batt_relay")
        mock_envoy.update.return_value = mock_envoy.data
...
async def setup_integration(
    ...
    """Set up the component and verify the expected state."""
