...
@test
async def empty_config(hass: HomeAssistant = Depends(hass_fx)) -> None:
...
@test
async def empty_credential(hass: HomeAssistant = Depends(hass_fx)) -> None:
    ...
    expect(hass.services.has_service("notify", "new_lambda_test")).to_be(True)
...
@test
async def profile_credential(hass: HomeAssistant = Depends(hass_fx)) -> None:
    ...
    expect(hass.services.has_service("notify", "sns_test")).to_be(True)
    await hass.services.async_call(
        "notify",
        "sns_test",
...
@test
async def access_key_credential(hass: HomeAssistant = Depends(hass_fx)) -> None:
...
@test
async def notify_credential(hass: HomeAssistant = Depends(hass_fx)) -> None:
    ...
    expect(hass.services.has_service("notify", "sqs_test")).to_be(True)
    await hass.services.async_call(
...
@test
async def notify_credential_profile(hass: HomeAssistant = Depends(hass_fx)) -> None:
...
@test
async def credential_skip_validate(hass: HomeAssistant = Depends(hass_fx)) -> None:
...
@test
async def service_call_extra_data(hass: HomeAssistant = Depends(hass_fx)) -> None:
...
@test
async def events_service_call(hass: HomeAssistant = Depends(hass_fx)) -> None:
    ...
    expect(hass.services.has_service("notify", "events_test")).to_be(True)
...
@test
async def events_service_call_10_targets(hass: HomeAssistant = Depends(hass_fx)) -> None:
