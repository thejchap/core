"""Tryke fixtures for the mta integration."""
...
def mock_config_entry_with_subway_subentry(
    ...
    mock_subway_subentry: ConfigSubentry = Depends(mock_subway_subentry),
) -> MockConfigEntry:
...
def mock_config_entry_with_bus_subentry(
    ...
    mock_bus_subentry: ConfigSubentry = Depends(mock_bus_subentry),
) -> MockConfigEntry:
