...
@test.cases(
    test.case("connection_error", exception=ConnectionError(), error="cannot_connect"),
    test.case("authentication_error", exception=AuthenticationError(), error="invalid_auth"),
    test.case("ip_auth_error", exception=IPAuthenticationError(), error="invalid_ip_auth"),
    test.case("tls_verification_error", exception=TLSVerificationError(), error="tls_error"),
    test.case("bad_request", exception=BadRequestError(), error="bad_request"),
    test.case("ping_error", exception=PingError(), error="cannot_connect"),
