...
def module_importable() -> None:
    """Smoke test: the homeassistant.components.xbox.remote module imports cleanly."""
    from homeassistant.components.xbox import remote  # noqa: PLC0415
    expect(remote).not_.to_be(None)
